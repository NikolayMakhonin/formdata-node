import { __classPrivateFieldSet, __classPrivateFieldGet, __awaiter, __asyncValues } from 'tslib';
import { ReadableStream } from 'web-streams-polyfill';
import { isFunction } from './isFunction.mjs';
import { sliceBlob, consumeBlobParts } from './blobHelpers.mjs';
...
class Blob {
    ...
    text() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result = '';
            try {
                for (var _b = __asyncValues(consumeBlobParts(__classPrivateFieldGet(this, _Blob_parts, "f"))), _c; _c = yield _b.next(), !_c.done;) {
